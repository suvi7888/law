...
var Main = function() {
	...
	var settingsHandler = function() {
		...
		$('#skin_color').attr("href", base_url+"assets/assets_backend/css/themes/" + appSetting.theme + ".css");
		...
		$('input[name="setting-theme"]').change(function() {
			...
			$('#skin_color').attr("href", base_url+"assets/assets_backend/css/themes/" + selectedTheme + ".css");
		...
		function switchLogo(theme) {
			switch (theme) {
				...
				case "theme-5":
				case "theme-6":
					$(".navbar-brand img").attr("src", base_url+"assets/assets_frontend/images/logo/fav-icon.png");
					break;
		...
		function defaultSetting() {
			...
			$('#skin_color').attr("href", base_url+"assets/sera_website/assets_backend/css/themes/theme-1.css");
			$(".navbar-brand img").attr("src", base_url+"assets/assets_frontend/images/logo/fav-icon.png");
