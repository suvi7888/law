		...
		<section id="history" class="profile pdd-vertical-kosong">
			<div class="carousel slide vertical" id="carousel-vertical" data-ride="carousel">
				...
				<div class="carousel-inner" role="listbox">
					<?php if ($this->agent->is_mobile()) { $ssCol = 'photo_litle'; } else { $ssCol = 'photo'; } ?>
					<?php for($i=0; $i<count($allTahun); $i++){ $row = $allGambar[$allTahun[$i]]; ?>
					<div class="item <?php echo $i==0?'active':''; ?>" style="background-image:url(<?php echo base_url("uploads/contents/".$row[$ssCol]);?>)">
						<div class="col-md-5">
