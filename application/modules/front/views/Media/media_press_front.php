    ...
    <div class="fs-slider">
        <div id="fs-slider-nav" class="carousel slide carousel-fade scale" data-ride="carousel">
            <div class="carousel-inner">
                ...
                <a href="#press" class="tohash scroll-to"><i class="ti-angle-down"></i> </a>
            </div>
            <!-- /carousel-inner -->
        ...
        <div class="block-second-menu menu col-md-12 hidden-xs hidden-sm">
            ...
            <div class="breadcrumb pull-right mrg-top-10">
                <ul>
                    ...
                    <li><a class="active" href="<?php echo site_url(strtolower($this->session->userdata('SS_LANG')).'/'.'media-press'); ?>">Press Releases</a></li>
          ...
          <ul class="nav navbar-nav">
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="<?php echo site_url(strtolower($this->session->userdata('SS_LANG')).'/'.'media'); ?>">News & Event</a></li>
                <li class="divider"></li>
                <li><a href="<?php echo site_url(strtolower($this->session->userdata('SS_LANG')).'/'.'media-press'); ?>"><span class="glyphicon glyphicon-chevron-right"></span> Press Releases</a></li>
                <li class="divider"></li>
                <li><a href="<?php echo site_url(strtolower($this->session->userdata('SS_LANG')).'/'.'media-photo'); ?>">Photos & video</a></li>
                <li class="divider"></li>
                <li><a href="<?php echo site_url(strtolower($this->session->userdata('SS_LANG')).'/'.'media-relasi'); ?>">Media Relations</a></li>
...
<!-- Contact -->
<section id="press" class="media-page pdd-vertical-50">
    <div class="container">
        <div class="content-news">
            <div class="row">
                <div class="title-big mrg-btm-30" align="center">
                    <h2 class="hero-heading text-purple text-center">PRESS & RELEASES</h2>
        ...
        <div class="row">
            <div class="col-md-12 pagi-overlay nav-overlay owl-carousl owl-theme">
