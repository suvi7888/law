...
<section class="header">
    <div class="block-second-menu menu col-md-12 hidden-xs hidden-sm">
        ...
        <div class="breadcrumb pull-right mrg-top-10">
            <ul>
                <li><a class="active" href="<?php echo site_url(strtolower($this->session->userdata('SS_LANG')).'/'.'media'); ?>">News & Event</a></li>
      ...
      <ul class="nav navbar-nav">
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="<?php echo site_url(strtolower($this->session->userdata('SS_LANG')).'/'.'media'); ?>"><span class="glyphicon glyphicon-chevron-right"></span> News & Event</a></li>
            <li class="divider"></li>
            <li><a href="<?php echo site_url(strtolower($this->session->userdata('SS_LANG')).'/'.'media-press'); ?>">Press Releases</a></li>
            <li class="divider"></li>
            <li><a href="<?php echo site_url(strtolower($this->session->userdata('SS_LANG')).'/'.'media-photo'); ?>">Photos & video</a></li>
...
<section id="news" class="media-page pdd-vertical-50">
                ...
                <div class="category-media mrg-top-10">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu mrg-left-15 col-md-6" aria-labelledby="kategori">
                          ...
                          <li <?php echo $l->slug_bu ==  @$slugbu ? 'class="active"' : ''; ?>><a href="<?php echo site_url(strtolower($this->session->userdata('SS_LANG')).'/'.'media/news-and-event/'.$l->slug_bu); ?>"><?php echo $l->nama_bu; ?></a></li> 
                          <li class="divider"></li> 
                          <?php } ?>
                          <!-- End -->
                                        ...
                                        <div class="news-meta">
                                          ...
                                          <div class="desc-asrticle" align="center">
                                            ...
                                            <div class="btn-read mrg-top-30">
                                                <a href="<?php echo site_url(strtolower($this->session->userdata('SS_LANG')).'/'.'news/'.date('Y',strtotime($n->datepost)).'/'.date('m',strtotime($n->datepost)).'/'.$n->slug); ?>">Read More&nbsp;<i class="ti-angle-right"></i></a>
                                            </div>
                                        </div>
                                    </div> 
                                </div> 
    ...
    <div class="row" align="center">
        <div class="btn-read-more mrg-top-50">
            <a href="<?php echo site_url(strtolower($this->session->userdata('SS_LANG')).'/'.'kategori/news-and-event'); ?>">Load More</a>
        </div>
    </div>  
</div>
    ...
    <div class="row">
        <div class="category-media mrg-top-10">
            <div class="dropdown">
                ...
                <ul class="dropdown-menu mrg-left-15 col-md-6" aria-labelledby="kategori">
                 <!-- Kategori -->
                                  <li><a href="<?php echo site_url(strtolower($this->session->userdata('SS_LANG')).'/'.'media/info-and-tips/transportasi'); ?>">TRANSPORTASI</a></li> 
                 <li class="divider"></li> 
                                  <li><a href="<?php echo site_url(strtolower($this->session->userdata('SS_LANG')).'/'.'media/info-and-tips/teknologi'); ?>">TEKNOLOGI</a></li>  
                 <li class="divider"></li> 
                                  <li><a href="<?php echo site_url(strtolower($this->session->userdata('SS_LANG')).'/'.'media/info-and-tips/logistik'); ?>">LOGISTIK</a></li>  
                                  <!-- End --> 
                            </ul>
                        </div>
                    </div>
