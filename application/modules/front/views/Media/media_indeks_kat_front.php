...
<section class="header">
    <div class="block-second-menu menu col-md-12 hidden-xs hidden-sm">
        <div class="breadcrumb pull-left mrg-top-10">
            <ul>
                <li><a class="active" href="<?php echo site_url(strtolower($this->session->userdata('SS_LANG')).'/'.'media'); ?>"><b>Media</b></a></li>
            </ul>
        </div> 
        ...
        <div class="content-news">
            <div class="row">
                <div class="title-big mrg-btm-30" align="center">
                    <h2 class="hero-heading text-purple text-center"><?php echo str_replace('-',' ', $this->uri->segment(2)).'   '.@$this->uri->segment(3); ?></h2>
