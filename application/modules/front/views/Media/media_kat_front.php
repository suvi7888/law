    ...
    <div class="fs-slider">
        <div id="fs-slider-nav" class="carousel slide carousel-fade scale" data-ride="carousel">
            <div class="carousel-inner">
                <div class="active item bg" style="background-image:url(<?php echo base_url("assets/assets_frontend/images/background/header-media-news.jpg"); ?>)">
...
<section class="header">
    <div class="block-second-menu menu col-md-12 hidden-xs hidden-sm">
        ...
        <div class="breadcrumb pull-right mrg-top-10">
            <ul>
                <li><a class="active" href="<?php echo site_url('media'); ?>">News & Event</a></li>
                ...
                <div class="category-media mrg-top-10">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu mrg-left-15 col-md-6" aria-labelledby="kategori">
                            ...
                            <li <?php echo $l->slug_bu ==  @$slugbu ? 'class="active"' : ''; ?>><a href="<?php echo site_url('media/'.$l->link.'/'.$l->slug_bu); ?>"><?php echo $l->nama_bu; ?></a></li> 
                            <li class="divider"></li> 
                            <?php } ?>
                            <!-- End -->
                        </ul>
