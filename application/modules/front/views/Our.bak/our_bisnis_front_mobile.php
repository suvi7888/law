...
<head>
    ...
    if(!isset($_COOKIE['seraweb'])) { ?>  
         <div class="cookie-container cookie">
            ...
            <button  onclick="document.cookie=&quot;seraweb=setujucookies;expires=Wed, 18 Dec <?php echo $tahun; ?> 12:00:00 GMT&quot;" alt="Accept cookies"><i class="fa fa-check"></i></button>
        </div> 
    <?php } ?>
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <div class="btn-language">
                                    <label><a class="in <?php echo (empty($_GET['lang'])?'active':''); ?>" href="?lang=ID">ID</a></label>
