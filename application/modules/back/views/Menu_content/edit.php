		...
		<div class="form-group">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="imgalt_1">
                            Img Description Indonesia
                        </label>
                        <input type="text" name="imgalt_1"  placeholder="Image Description ID" 
                        class="form-control" style="margin: 0; padding: 0;" value="<?php echo set_value('imgalt_1', isset($detail['imgalt_1']) ? $detail['imgalt_1'] : ''); ?>">
                        <span class="help-block"><?php echo form_error('imgalt_1'); ?></span>
                    </div>
                </div>
                <div class="col-sm-6"> 
                    <div class="form-group">
                        <label for="imgalt_2">
                            Img Description English
                        </label>
                        <input type="text" name="imgalt_2" 
                        value="<?php echo set_value('imgalt_2', isset($detail['imgalt_2']) ? $detail['imgalt_2'] : ''); ?>" 
                        placeholder="Image Description EN" 
                        id="imgalt_2" 
                        class="form-control" style="margin: 0; padding: 0;">
                        <span class="help-block"><?php echo form_error('imgalt_2'); ?></span>
                    </div>
                </div>
            </div>
		...
		<div class="panel panel-white">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					...
					<?php if ($detailMenu['menu_detail_id'] == '19') { ?>

						<textarea name="subtitle_<?php echo $row['language_id']; ?>" id="subtitle_<?php echo $row['language_id']; ?>" class="form-control"><?php echo set_value('subtitle_'.$row['language_id'], isset($detail['subtitle_'.$row['language_id']]) ? trim($detail['subtitle_'.$row['language_id']]) : ''); ?></textarea>
