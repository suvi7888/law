...
<h5 class="over-title margin-bottom-15"><span class="text-bold">Master submenu</span></h5> 

<div class="row">
	<div class="col-md-12">
		
		<?php echo anchor('back/menu_detail/input', '<i class="fa fa-plus"></i> Add submenu','class="btn btn-primary"') ;?>
		<br><br>
...
$(document).ready(function() {
	table = $('#table').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('back/menu_detail/ambildata')?>",
            "type": "POST"
        },
