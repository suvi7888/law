...
<div class="row">
	<?php echo form_open('back/kantor/grup_edit/'.$detail['id']); ?>
		...
		<div class="form-group">
			...
			<div class="input-group">
				<select name="status" class="form-control">
					<option value="1" <?php echo set_value('status', isset($detail['status']) ? ($detail['status']=='1'?'selected' :'') : ''); ?>>Aktif</option>
					<option value="0" <?php echo set_value('status', isset($detail['status']) ? ($detail['status']=='0'?'selected' :'') : ''); ?>>Non-Aktif</option>
				</select>
